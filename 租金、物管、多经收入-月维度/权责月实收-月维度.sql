...
select t1.project_id,                                                                                      -- 项目id
       ...
       if(t1.financial_date is null, t1.financial_date, concat_ws('-', t1.financial_date, '01')),          -- 权责月
       t1.received_amount,                                                                                 -- 已核销金额
       t1.unverified_amount,                                                                               -- 未核销金额
       if(t1.verification_date is null, t1.verification_date, concat_ws('-', t1.verification_date, '01')), -- 核销月份
       t1.tenant_name,                                                                                     -- 商家名称
       t1.tenant_id,                                                                                       -- 商家id
       t1.cont_id,                                                                                         -- 合同id
       t1.cont_no,                                                                                         -- 合同号
